...
/datum/emergency_call/cmb/anchorpoint/New()
	..()
	arrival_message = "[MAIN_SHIP_NAME], this is Anchorpoint Station. Be advised, a QRF Team of our Agents is currently attempting to board you. Open your ports, transmitting docking codes now. Standby."
