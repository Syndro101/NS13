...
//---HGSL---//
/datum/equipment_preset/uscm_helldivers/hgsl
	name = "Honorguard Squad Leader(helldivers)"
	flags = EQUIPMENT_PRESET_START_OF_ROUND|EQUIPMENT_PRESET_MARINE
...
/datum/equipment_preset/uscm_helldivers/hgsl/load_gear(mob/living/carbon/human/new_human)
...
//---VHG---//
/datum/equipment_preset/uscm_helldivers/vhg
	name = "Veteran Honor Guard(helldivers)"
...
/datum/equipment_preset/uscm_helldivers/vhg/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m41aMK1/heap(new_human), WEAR_IN_R_STORE)
//---PO---//
/datum/equipment_preset/uscm_helldivers/po
	name = "USCM Pilot (helldivers)"
	flags = EQUIPMENT_PRESET_START_OF_ROUND|EQUIPMENT_PRESET_MARINE
...
/datum/equipment_preset/uscm_helldivers/po/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/satchel
	if(new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/marine
...
//---Tank Crwmn---//
/datum/equipment_preset/uscm_helldivers/tank
	name = "USCM Vehicle Crewman (helldivers)"
	flags = EQUIPMENT_PRESET_EXTRA|EQUIPMENT_PRESET_MARINE
...
/datum/equipment_preset/uscm_helldivers/tank/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/marine/satchel
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/marine
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/patch(new_human), WEAR_ACCESSORY)
//---Intel---//
/datum/equipment_preset/uscm_helldivers/intel
	name = "USCM Intelligence Officer (helldivers)"
	flags = EQUIPMENT_PRESET_START_OF_ROUND|EQUIPMENT_PRESET_MARINE
...
/datum/equipment_preset/uscm_helldivers/intel/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/marine/satchel
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/marine
...
//----Medical----//
/datum/equipment_preset/uscm_ship/uscm_helldivers/medical
...
//---CMO---//
/datum/equipment_preset/uscm_ship/uscm_helldivers/medical/cmo
	name = "USCM Chief Medical Officer (helldivers)"
	flags = EQUIPMENT_PRESET_START_OF_ROUND|EQUIPMENT_PRESET_MARINE
...
/datum/equipment_preset/uscm_ship/uscm_helldivers/medical/cmo/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/marine/satchel
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/marine
...
//---Surgeon---//
/datum/equipment_preset/uscm_ship/uscm_helldivers/medical/doctor
	name = "USCM Surgeon(helldivers)"
	flags = EQUIPMENT_PRESET_START_OF_ROUND|EQUIPMENT_PRESET_MARINE
...
/datum/equipment_preset/uscm_ship/uscm_helldivers/medical/doctor/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/marine/satchel
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/marine
...
/datum/equipment_preset/uscm_ship/uscm_helldivers/medical/surgeon

	assignment = JOB_MS_SURGEON


//---WY-Sci---//
/datum/equipment_preset/uscm_ship/uscm_helldivers/medical/researcher
	name = "Corporate Researcher(Helldivers)"
...
/datum/equipment_preset/uscm_ship/uscm_helldivers/medical/researcher/load_gear(mob/living/carbon/human/new_human)
	var/back_item = /obj/item/storage/backpack/marine/satchel
	if (new_human.client && new_human.client.prefs && (new_human.client.prefs.backbag == 1))
		back_item = /obj/item/storage/backpack/marine
